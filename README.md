...
- **Детекция движения** с настраиваемыми зонами и регулируемой чувствительностью (MSE алгоритм)
...
- **Веб-интерфейс** для просмотра записей, настройки зон и чувствительности детектора
- **Автоматическая ротация** файлов с контролем дискового пространства
- **Гибкая настройка чувствительности** - 4 предустановленных уровня + точная настройка
